...
def end_effector_func(theta):
    ...
    return position
desired_position = np.array([1, 2, 3])  # This should be your desired end effector position
pop_size = 100  # Size of the fruit fly population
max_iter = 1000  # Maximum number of iterations

best_position, best_smell = FOA(end_effector_func, desired_position, pop_size, max_iter)

print(f"Best position: {best_position}")
print(f"Best smell: {best_smell}")
